(function() {
  const fn = function() {
    ...
    (function(root) {
      ...
      const element = document.getElementById("cad5b309-c8df-4251-a1bc-9494e83bb397");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'cad5b309-c8df-4251-a1bc-9494e83bb397' but no matching script tag was found.")
        }
